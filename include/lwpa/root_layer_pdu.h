 ...
 *  @{
 */
#define LWPA_VECTOR_ROOT_SDT ACN_PROTOCOL_SDT
#define LWPA_VECTOR_ROOT_DRAFT_E131_DATA ACN_PROTOCOL_DRAFT_E131_DATA
#define LWPA_VECTOR_ROOT_E131_DATA ACN_PROTOCOL_E131_DATA
#define LWPA_VECTOR_ROOT_E131_EXTENDED ACN_PROTOCOL_E131_EXTENDED
#define LWPA_VECTOR_ROOT_LLRP ACN_PROTOCOL_LLRP
#define LWPA_VECTOR_ROOT_BROKER ACN_PROTOCOL_BROKER
#define LWPA_VECTOR_ROOT_RPT ACN_PROTOCOL_RPT
#define LWPA_VECTOR_ROOT_EPT ACN_PROTOCOL_EPT
/*!@}*/
