...
{
  etcpal_init(LWPA_FEATURE_SOCKETS);
}

TEST_TEAR_DOWN(etcpal_socket)
{
  etcpal_deinit(LWPA_FEATURE_SOCKETS);
}
...
{
  etcpal_socket_t send_sock = LWPA_SOCKET_INVALID;
  etcpal_socket_t rcvsock1 = LWPA_SOCKET_INVALID;
