                                    ...
                                    void* thread_arg)
{
  ...
  if (zparams.sched_mode == PREEMPTIVE)
	...
	{
		// Caution: This is REALLY hacky. Zephyr does not natively support dynamic thread creation.
		// this is a workaround.
		// See https://discord.com/channels/720317445772017664/884851987508781066/978399932732030998
		// Also soe the definition of Z_KERNEL_STACK_DEFINE_IN, Z_KERNEL_STACK_SIZE_ADJUST
		uint32_t stack_footprint = Z_KERNEL_STACK_SIZE_ADJUST(params->stack_size);
		id->my_stack = (k_thread_stack_t *)calloc(stack_footprint, sizeof(k_thread_stack_t));
		id->tid = k_thread_create(&id->my_thread,
			id->my_stack,
			params->stack_size,
