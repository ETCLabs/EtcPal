...
#define OUTPUT_TEST_MODULE_BEGIN(name) \
          printf("[TestModuleBegin:" name "]\n")

#define OUTPUT_TEST_MODULE_END(name, did_pass) \
          printf("[TestModuleEnd:" name ":%s]\n", did_pass ? "PASS" : "FAIL")

#define OUTPUT_TEST_BEGIN(name) \
          printf("[TestBegin:" name "]\n")

#define OUTPUT_TEST_RESULT(did_pass) \
          ((did_pass) ? printf("[TestResult:PASS]\n") \
