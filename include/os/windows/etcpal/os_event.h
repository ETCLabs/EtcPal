...
#ifndef ETCPAL_OS_EVENT_H_
#define ETCPAL_OS_EVENT_H_
...
typedef unsigned int etcpal_event_bits_t;
...
#define ETCPAL_EVENT_HAS_TIMED_WAIT 0
#define ETCPAL_EVENT_HAS_ISR_FUNCTIONS 0
#define ETCPAL_EVENT_WAKES_MULTIPLE_THREADS 0
...
#define etcpal_event_set_bits_from_isr etcpal_event_set_bits
#define etcpal_event_get_bits_from_isr etcpal_event_get_bits
#define etcpal_event_clear_bits_from_isr etcpal_event_clear_bits

#ifdef __cplusplus
}
#endif

#endif /* ETCPAL_OS_EVENT_H_ */
