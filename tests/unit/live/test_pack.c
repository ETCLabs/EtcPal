...
TEST_GROUP(lwpa_pack);

TEST_SETUP(lwpa_pack)
{
}

TEST_TEAR_DOWN(lwpa_pack)
{
}

TEST(lwpa_pack, pack_16_functions_work)
{
...
TEST(lwpa_pack, pack_32_functions_work)
{
  // Test packing and unpacking values at varying memory offsets.
  for (size_t offset = 0; offset <= 60; ++offset)
  {
...
TEST(lwpa_pack, pack_64_functions_work)
{
  // Test packing and unpacking values at varying memory offsets.
  for (size_t offset = 0; offset <= 60; ++offset)
  {
